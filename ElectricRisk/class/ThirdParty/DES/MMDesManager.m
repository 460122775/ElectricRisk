...
{
    NSString *tempStr = [MMDesManager AES128Encrypt: content withKey: CodingKey andIV: CodingOffset];
    if(nil != tempStr)
    {
        return [MMDesManager AES128Encrypt: tempStr withKey: CodingKey2 andIV: CodingOffset2];
    }
    return nil;
}

+ (NSString *)AES128Encrypt:(NSString *)plainText withKey:(NSString *)key andIV:(NSString *)IV
{
...
+(NSString *)doubleAES128Decrypt: (NSString *)encryptText
{
    NSString *tempStr = [MMDesManager AES128Decrypt: encryptText withKey: CodingKey2 andIV: CodingOffset2];
    if(tempStr != nil)
    {
        NSString *responseStr = [MMDesManager AES128Decrypt: tempStr withKey: CodingKey andIV: CodingOffset];
        return responseStr;
    }
    return nil;
}

+ (NSString *)AES128Decrypt:(NSString *)encryptText withKey:(NSString *)key andIV:(NSString *)IV
{
    char keyPtr[kCCKeySizeAES128 + 1];
