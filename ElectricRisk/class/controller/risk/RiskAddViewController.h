...
@interface RiskAddViewController : UIViewController<UIWebViewDelegate, RiskWrongListChooseDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>{
    MBProgressHUD *HUD;
